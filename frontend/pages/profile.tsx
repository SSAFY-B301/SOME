...
import {
  ProfileActivity,
  ProfileAlarm,
} from "@/components/pages/profile/ProfileData";
...
export default function MyPage() {
  ...
  async function kakaoLogout() {
    await axios.post(
      `${process.env.NEXT_PUBLIC_KAKAO_API_URL}/v1/user/logout`,
      {},
      {
        headers: {
  ...
  return (
    <div
      className="bg-bg-home dark:bg-dark-bg-home"
      ...
      <div className="flex flex-col items-center w-full gap-y-4">
        ...
        >
          ...
          <button
            onClick={() =>
              router.push(
                `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_KAKAO_RESTAPI_KEY}&redirect_uri=${process.env.NEXT_PUBLIC_REDIRECT_URI}&response_type=code&scope=account_email,profile_image,profile_nickname,friends`
              )
            }
