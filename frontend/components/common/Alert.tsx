  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-col items-center justify-center w-64 bg-white dark:bg-dark-bg-home rounded-lg h-28 gap-y-4"
      >
        <p>{props.msg}</p>
        <div className="flex items-center justify-center gap-x-4">
          <button onClick={props.yesHandler} className="w-24 rounded-lg shadow">
            예
          </button>
