...
import com.ssafy.somefriendgirl.entity.AutoIncrementSequence;
...
public class AmazonS3Service {
    ...
    public List<MetaDataDto> uploadFile(List<MultipartFile> multipartFiles) throws IOException, ImageProcessingException, MetadataException {
        List<MetaDataDto> metaDataDtos = new ArrayList<>();

        for (MultipartFile multipartFile : multipartFiles) {
            Long photoId = generateSequence(AlbumPhoto.SEQUENCE_NAME);

            String filePath = "map/" + photoId + "/";
